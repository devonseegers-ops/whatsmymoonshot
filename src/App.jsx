...
function LandingScreen({ go }) {
  ...
  const SAMPLE = "I am here to move souls, unite hearts, and raise the consciousness of humanity through music, art, and agentic systems so that the world remembers what it feels like to be alive, connected, and free.";
  const STEPS = [
      ...
      <section style={{padding:"20px 24px 60px",position:"relative",zIndex:1}}>
        <div style={{maxWidth:660,margin:"0 auto",textAlign:"center"}}>
          ...
          <div className="card" style={{padding:36,background:"radial-gradient(ellipse at top,rgba(0,217,255,.08) 0%,transparent 70%)",borderColor:"rgba(0,217,255,.2)"}}>
            ...
            <div style={{color:"var(--mt)",fontSize:11}}>Real statement generated by WhatsMyMoonshot.ai</div>
          </div>
        </div>
      </section>
      {/* TESTIMONIALS */}
